...
public class ApiCustomerPostController implements Controller {
	...
	//사용자가 보낸 데이터는 json 문자열 입니다. 이 데이터 읽어오기 위해 입력스트림이 필요합니다.
	InputStream inputStream = request.getInputStream();		//http 전송 방식의 입력스트림 생성. 요청 객체로 만들어집니다.
...
//	if(result==0) msg = "회원등록 오류입니다. id 중복확인하세요" ;
//	
